    ...
    var c = {
        ...
        createTabDom: function () {
            ...
            if (i._parentElem = e.elem, !i.tabDomExists()) {
                var a = ['<div class="layui-tab layui-tab-card kit-tab" lay-filter="' + i._filter + '">', '<ul class="layui-tab-title">', '<li class="layui-this"><i class="layui-icon">&#xe68e;</i> 首&nbsp;&nbsp;页</li>', "</ul>", '<div class="layui-tab-content" id="home">', '<div class="layui-tab-item layui-show"></div>', "</div>", "</div>"];
